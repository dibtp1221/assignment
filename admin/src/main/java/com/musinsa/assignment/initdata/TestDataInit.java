...
public class TestDataInit {
    ...
    public TestDataInit(ItemRepository itemRepository, BrandJpaRepository brandRepository, CategoryJpaRepository categoryRepository, CacheMessageProducer cacheMessageProducer) {
